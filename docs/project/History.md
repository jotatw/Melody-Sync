...
- Project reorganized into three parallel tracks: Real Use (Track A, active), Maintenance (Track B), Future Design (Track C); friction register created with F1–F5 pre-seeded and template for new entries; expansion criteria defined for each future expansion
