...
Health identifies problems; Library is the place where the user can inspect an affected song.

When the user chooses to review an issue:

- navigate to Library;
- select or focus the affected song;
- preserve enough context for the user to understand why the song was opened;
...
- Health may identify a song, but Library owns the song-level workspace.
