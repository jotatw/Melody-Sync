 ...
 *
 * [apply] only touches the audio file (via [TagWriter]) and returns a typed
 * [WriteResult]; persisting the updated [Song] to the database cache is the
...
object QuickFixService {
    ...
    fun apply(song: Song, suggestion: TagSuggestion): WriteResult =
